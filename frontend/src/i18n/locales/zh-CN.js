export default {
  ...
  markdown: {
    ...
    invalidFileType: "不支持的文件类型，请选择Markdown文件",
    fileTooLarge: "文件过大，请选择小于10MB的文件",
    confirmOverwrite: "当前编辑器已有内容，导入将覆盖现有内容。是否继续？",
    importingFile: "正在导入文件...",
    fileImported: "文件导入成功",
    importFailed: "导入失败，请重试",
    readError: "读取文件时出错，请重试",
    form: {
      remark: "备注(可选)",
  ...
  file: {
    ...
    urlAnalysisFailed: "URL解析失败",
    invalidUrl: "无效的URL格式",
    getPresignedUrlFailed: "获取上传授权失败",
    serverUploadFailed: "服务器上传失败",
